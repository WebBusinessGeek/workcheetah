  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shift as @shift" do
        ...
        post :create, {:shift => { "employee_id" => "invalid value" }}, valid_session
        assigns(:shift).should be_a_new(Shift)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shift" do
        ...
        Shift.any_instance.should_receive(:update_attributes).with({ "employee_id" => "1" })
        put :update, {:id => shift.to_param, :shift => { "employee_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the shift as @shift" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Shift.any_instance.stub(:save).and_return(false)
        put :update, {:id => shift.to_param, :shift => { "employee_id" => "invalid value" }}, valid_session
        assigns(:shift).should eq(shift)
      end
