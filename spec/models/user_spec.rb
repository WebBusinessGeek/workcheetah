...
describe User do
  describe "Assocations" do
		[ :conversations, :conversation_items, :job_applications, :participations, :scam_reports, :requested_video_chats, :received_video_chats, :video_chat_messages ].each do |association_name|
