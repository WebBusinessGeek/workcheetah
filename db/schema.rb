...
ActiveRecord::Schema.define(:version => 20131204230307) do
  ...
  create_table "articles", :force => true do |t|
    ...
    t.timestamp "cover_updated_at",   :limit => 6
    t.string    "subtitle"
  ...
  create_table "confirmations", :force => true do |t|
    ...
    t.timestamp "confirmation_sent",  :limit => 6
    t.timestamp "confirmated_at",     :limit => 6
  ...
  create_table "project_documents", :force => true do |t|
    ...
    t.timestamp "document_updated_at",   :limit => 6
    t.timestamp "created_at",            :limit => 6, :null => false
    t.timestamp "updated_at",            :limit => 6, :null => false
  end
  ...
  create_table "shifts", :force => true do |t|
    ...
    t.timestamp "start_hour",    :limit => 6
    t.timestamp "end_hour",      :limit => 6
  ...
  create_table "users", :force => true do |t|
    ...
    t.timestamp "invitation_created_at",  :limit => 6
    t.timestamp "invitation_sent_at",     :limit => 6
    t.timestamp "invitation_accepted_at", :limit => 6
