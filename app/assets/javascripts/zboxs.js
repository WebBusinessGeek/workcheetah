...
(function($){
	$.movingBoxes = function(el, options){
        ...
        base.init = function(){
			...
			base.$panels = base.$el.children(); // mb-panels
		...
		base.update = function(callback, flag){
			...
			base.adj = (o.wrap && base.$panels.length > 1) ? -1 : 1; // count adjustment for infinite panels
			...
			if (o.wrap && base.$panels.length > 1) {
                ...
                base.$el.append( base.$panels.filter(':nth-child(4)').clone().addClass('cloned') );
...
/* MovingBoxes demo script   demo/demo.js */

$(function(){
	$('#slider-one').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
	...
	$('#slider-six').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-seven').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-eight').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-nine').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-ten').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-eleven').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-twelve').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-thirteen').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-fourteen').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-fifteen').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
	});
	$('#slider-sixteen').movingBoxes({
		startPanel   : 1,      // start with this panel   // non-current panel size: 80% of panel size
		wrap         : true,   // if true, the panel will "wrap" (it really rewinds/fast forwards) at the ends
		buildNav     : true,   // if true, navigation links will be added
		navFormatter : function(){ return "&#9679;"; } // function which returns the navigation text for each panel
