class User < ActiveRecord::Base
  ...
  has_many :confirmed_references, class_name: "Confirmation", foreign_key: "confirmed_for"
  has_many :confirmation_requests, class_name: "Confirmation", foreign_key: "confirmed_by"
